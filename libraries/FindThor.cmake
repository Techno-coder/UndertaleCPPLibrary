...
find_path(AURORA_INCLUDE_DIR extlibs/aurora/include/Aurora/Config.hpp
        PATHS
        ${THOR_ROOT}
        $ENV{THOR_ROOT}
        /usr/local/
        ...
        /opt/csw/    # Blastwave
        /opt/)
set(AURORA_INCLUDE_DIR ${AURORA_INCLUDE_DIR}/extlibs/aurora/include)
...
if(THOR_FOUND)
	...
	message("Found Aurora: ${AURORA_INCLUDE_DIR}")
else()
